...
const HeroSection = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center relative overflow-hidden bg-background">
      ...
      {floatingIcons.map((item, index) => <div key={index} className={`absolute ${item.position} ${item.size} hidden lg:flex items-center justify-center text-2xl animate-float-slow opacity-60`} style={{
      ...
      <div className="container-custom section-padding pt-32 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="order-2 lg:order-1 text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6 animate-fade-up opacity-0" style={{
            animationDelay: '0.1s',
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground mb-4 animate-fade-up opacity-0" style={{
            animationDelay: '0.2s',
            animationFillMode: 'forwards'
          }}>
              Hi, I'm{' '}
            ...
            <div className="h-16 md:h-20 flex items-center justify-center lg:justify-start animate-fade-up opacity-0" style={{
            animationDelay: '0.3s',
            animationFillMode: 'forwards'
          }}>
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-up opacity-0" style={{
            animationDelay: '0.4s',
            animationFillMode: 'forwards'
          }}>
            ...
            {/* CTA Buttons */}
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start animate-fade-up opacity-0" style={{
            animationDelay: '0.5s',
            animationFillMode: 'forwards'
          }}>
            ...
            {/* Stats */}
            <div className="flex flex-wrap gap-8 mt-12 justify-center lg:justify-start animate-fade-up opacity-0" style={{
            animationDelay: '0.6s',
            animationFillMode: 'forwards'
          }}>
              {[{
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
            <div className="relative animate-fade-up opacity-0" style={{
            animationDelay: '0.3s',
            animationFillMode: 'forwards'
          }}>
              {/* Animated ring */}
              ...
              <div className="relative">
                ...
                <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[420px] lg:h-[420px] rounded-full overflow-hidden border-4 border-card shadow-2xl bg-card">
                  <img alt="Evrahim Hasan Emran - Frontend Web Developer" className="w-full h-full object-cover" src="https://i.ibb.co.com/5q0snhF/772463-O.png" />
                </div>
